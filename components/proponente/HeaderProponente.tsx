...
export default function HeaderProponente() {
  return <header className="sticky top-0 z-30 glass border-b border-border">
    <div className="mx-auto max-w-7xl px-6 h-16 flex items-center gap-4">
      ...
      <div className="hidden sm:block">
        <div className="text-[10px] uppercase tracking-[0.18em] text-muted-foreground font-mono">Área do proponente</div>
        <div className="text-sm font-medium leading-tight">Instituto Verde Tocantins</div>
      </div>
